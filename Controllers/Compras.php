...
class Compras extends Controller{
    ...
    public function generarPdf($folio)
    {
        ...
        $pdf->Image('Assets/img/PHPl.png', 50, 16, 25, 25);
        $pdf->SetFont('Arial', 'B', 10);
        $pdf->Cell(18, 5, 'Dui: ', 0, 0, 'L');
        ...
        $pdf->SetFont('Arial', 'B', 10);
        $pdf->Cell(20, 5, utf8_decode('Contacto'), 0, 0, 'L');
        $pdf->SetFont('Arial', '', 10);
    ...
    public function generarVentaPdf($folio)
    {
        ...
        $pdf->Cell(18, 5, utf8_decode('Contacto: '), 0, 0, 'L');
        $pdf->SetFont('Arial', '', 10);
        $contacto_empresa = isset($empresa['Contacto']) ? $empresa['Contacto'] : 'Sin contacto';
        $pdf->Cell(20, 5, utf8_decode($contacto_empresa), 0, 1, 'L');
        ...
        $pdf->Cell(20, 5, utf8_decode('Contacto'), 0, 0, 'L');
        $pdf->SetFont('Arial', '', 10);
        $contacto_cliente = isset($cliente['Contacto']) ? $cliente['Contacto'] : 'Sin contacto';
        $pdf->Cell(35, 5, utf8_decode($contacto_cliente), 0, 1, 'L');
