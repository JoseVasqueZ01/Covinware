                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input id="codigo" class="form-control" type="text" name="codigo" placeholder="Ingrese un codigo" required>
                            </div>
                            <div class="form-group">
                                <label for="categoria">Nombre </label>
                                <input id="categoria" class="form-control" type="text" name="categoria" placeholder="Ingrese el nombre de la categoria" required>
                            </div>
                        </div>
                    </div>
                </div>
