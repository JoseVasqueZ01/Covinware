    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar bg-white elevation-4">
            ...
            <a href="<?php echo base_url; ?>admin" class="brand-link">
                <img src="<?php echo base_url; ?>Assets/img/logo.jpg" alt="Logo" class="brand-image elevation-3" style="width: 35px; border-radius: 10%;">
                <span class="brand-text font-weight-light" style="font-size: 30px;">CovinWare</span>
            </a>
