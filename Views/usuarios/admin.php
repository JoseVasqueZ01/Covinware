            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input id="identidad" class="form-control" type="text" name="identidad" value="<?php echo $data['identidad'] ?>" placeholder="Identidad" onkeypress="return soloNumeros(event);" oninput="longitud(event, 9)">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
